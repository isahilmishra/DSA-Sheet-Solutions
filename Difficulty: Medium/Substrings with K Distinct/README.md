<h2><a href="https://www.geeksforgeeks.org/problems/count-number-of-substrings4528/1">Substrings with K Distinct</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 14pt;">You are given a string consisting<strong>&nbsp;</strong>of lowercase characters and an integer <strong>k</strong>, You have to count all possible <strong>substrings </strong>that have <strong>exactly k distinct</strong> characters.&nbsp;</span></p>
